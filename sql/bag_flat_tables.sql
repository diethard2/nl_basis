...
(id, straat, huisnummer, postcode, woonplaats, gemeente, oppervlakte, gebruiksdoel, id_pand, geometry)
SELECT id, naam_openbare_ruimte, huisnummer, postcode, woonplaats, gemeente, oppervlakte, gebruiksdoel, id_pand, geometry FROM view_verblijfsobject
--
...
(id, straat, huisnummer, postcode, woonplaats, gemeente, geometry)
SELECT id, naam_openbare_ruimte, huisnummer, postcode, woonplaats, gemeente, geometry 
FROM view_ligplaats
--
